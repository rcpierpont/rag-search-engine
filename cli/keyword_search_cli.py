import argparse
from lib.keyword_search import build_command, search_command, tf_command, idf_command, tfidf_command, bm25_idf_command, bm25_tf_command, bm25search_command
...
def main() -> None:
    ...
    match args.command:
        ...
        case "bm25tf":
            print("Checking BM25 TF score...")
            bm25tf = bm25_tf_command(args.doc_id, args.term)
            print(f"BM25 TF score of '{args.term}' in document '{args.doc_id}': {bm25tf:.2f}")
        case "bm25search":
            print(f"Fetching top {args.limit} movies based on BM25 score...")
            bm25_results = bm25search_command(args.query, args.limit)
